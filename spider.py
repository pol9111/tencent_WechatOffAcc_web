...
class Spider():
    ...
    def search_off_acc(self):
        ...
        for query in official_acc:
            ...
            # 在搜索接口搜索某公众号的url构造
            search_rs = requests.get(self.search_url, headers=self.headers, cookies=self.cookies, params=query_id)
    ...
    def enter_off_acc(self, fakeid):
        ...
        appmsg_rs = requests.get(self.appmsg_url, headers=self.headers, cookies=self.cookies, params=query_id_data)
    ...
    def get_each_page(self, fakeid, num):
        ...
        while num + 1 > 0:
            ...
            acc_eachpage_rs = requests.get(self.appmsg_url, headers=self.headers, cookies=self.cookies, params=query_id_data)
            ...
            for item in article_list:
                ...
                print(data)
                self.table.update({'文章标题': title}, {'$set': data}, True)
            num -= 1
            begin += 5
            time.sleep(15)
            print('next_page' + '-'*20 + '\n'*3)
